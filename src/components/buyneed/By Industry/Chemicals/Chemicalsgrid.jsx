...
const features = [
  {
    icon: Cpu,
    title: "Model and Simulate Molecular Interactions",
    description: "Model and simulate molecular interactions before synthesis.",
    bgColor: "#3b82f6", // Blue
    hoverColor: "#1d4ed8"
  },
  {
    icon: Zap,
    title: "Predict Performance Properties",
    description: "Predict performance properties under real-world conditions.",
    bgColor: "#f97316", // Orange
    hoverColor: "#ea580c"
  },
  {
    icon: Thermometer,
    title: "AI-Guided Formulation Design",
    description: "Design optimized formulations with AI-guided ingredient selection.",
  ...
  },
  {
    ...
    description: "Identify process bottlenecks and streamline production workflows.",
    bgColor: "#f43f5e", // Red/Pink
    hoverColor: "#e11d48"
  },
  {
    icon: Box,
    title: "Integrate End-to-End Data",
    description: "Integrate lab, pilot plant, and manufacturing data for end-to-end insight.",
  ...
  },
  {
    ...
    description: "Minimize waste with sustainability-focused design recommendations.",
  ...
  },
  {
    ...
    description: "Build and share collaborative R&D spaces with your teams.",
    bgColor: "#06b6d4", // Teal
    hoverColor: "#0891b2"
  },
  {
    ...
    description: "Deliver ready-to-share technical reports and regulatory summaries.",
    ...
    <section style={containerStyle} ref={sectionRef}>
      <div style={headerStyle}>
        <h2 style={{
         ...
         Accelerate Chemical Innovation Cycles
