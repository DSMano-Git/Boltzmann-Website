...
const PMNumbers = () => {
  ...
  const statsData = [
    {
      color: "#00BCD4",
      description: "faster biomarker-to-therapy cycles."
    },
    {
      color: "#E91E63", 
      description: "of patient stratification workflows automated."
    },
    {
      color: "#FF5722",
      description: "parameters optimized for individual patient profiles."
    }
  ];
        ...
        >
          ...
          >
            ...
            >
              ...
              >
            Deliver Right-First-Time Precision Medicine
              </h2>
              <p
                style={{
              ...
              >
            In today’s high-stakes healthcare environment, being first-to-market isn’t enough—you need to be right-for-the-right-patient the first time. The Boltzmann AI Discovery Suite doesn’t just accelerate your science; it empowers your teams to deliver safer, more effective, and more personalized treatments—faster.
