...
const features = [
  {
    icon: Database,
    title: "Integrate Multi-Omics & Clinical Data",
    description: "Integrate genomic, proteomic, metabolomic, and clinical datasets.",
    bgColor: "#4f46e5", // Indigo
    hoverColor: "#4338ca",
  },
  {
    icon: Search,
    title: "Discover Novel Biomarkers",
    description: "Discover novel biomarkers linked to disease progression or drug response.",
    bgColor: "#10b981", // Emerald Green
    hoverColor: "#047857",
  },
  {
    icon: Cpu,
    title: "Predict Treatment Efficacy",
    description: "Predict treatment efficacy for specific patient subgroups.",
    bgColor: "#f59e0b", // Amber
    hoverColor: "#b45309",
  },
  {
    icon: Activity,
    title: "Model Patient PK/PD",
    description: "Model patient-specific pharmacokinetics and pharmacodynamics (PK/PD).",
    bgColor: "#ef4444", // Red
    hoverColor: "#b91c1c",
  },
  {
    icon: Thermometer,
    title: "Optimize Dosing Regimens",
    description: "Identify optimal dosing regimens based on genetic and metabolic profiles.",
    bgColor: "#6366f1", // Blue Purple
    hoverColor: "#4f46e5",
  },
  {
    icon: AlertTriangle,
    title: "Detect Off-Target Effects",
    description: "Detect off-target effects early to reduce adverse events.",
    bgColor: "#f97316", // Orange
    hoverColor: "#c2410c",
  },
  {
    icon: Users,
    title: "Secure Collaborative Research Spaces",
    description: "Build secure, shareable patient-cohort research spaces.",
    bgColor: "#06b6d4", // Teal
    hoverColor: "#0891b2",
  },
  {
    ...
    description: "Generate regulatory-ready reports for precision clinical trials.",
