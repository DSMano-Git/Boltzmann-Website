...
const ArNumbers = () => {
  ...
  const statsData = [
    {
      color: "#00BCD4",
      description: "faster data analysis cycles."
    },
    {
      color: "#E91E63", 
      description: "of repetitive research tasks automated."
    },
    {
      color: "#FF5722",
      description: "experimental parameters optimized in a single iteration."
    }
  ];
        ...
        >
          ...
          >
            ...
            >
              ...
              >
             Maximize Research Impact with Speed, Accuracy, and Reproducibility
              </h2>
              <p
                style={{
              ...
              >
              In today’s competitive research environment, impact isn’t measured only in publications—it’s about being first, being right, and being reproducible. The Boltzmann AI Discovery Suite doesn’t just accelerate your work; it empowers your teams to analyze deeper, collaborate seamlessly, and innovate with confidence.
