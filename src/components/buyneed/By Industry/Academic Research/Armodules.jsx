...
const modules = [
  {
    name: "Compress Research Timelines",
    description: `
Traditional research cycles take months or years—our platform helps you move faster.
- AI-powered data cleaning and preprocessing in minutes, not days.
- Automated hypothesis testing using predictive algorithms.
- Rapid simulation and modeling to validate theories before lab work.
    `,
    imageUrl:
      "https://images.unsplash.com/photo-1693919653649-27492e78899d?q=80&w=3132&auto=format&fit=crop&ixlib=rb-4.1.0",
  },
  {
    name: "Reduce Error and Improve Reproducibility",
    description: `
Reproducibility is the cornerstone of good science—our tools keep it front and center.
- Automated protocol documentation for consistent execution.
- Integrated statistical checks to reduce false positives.
- Version control for datasets, models, and experiments.
  ...
  {
    name: "Unlock Cross-Disciplinary Opportunities",
    description: `
Bring together knowledge from across the research spectrum.
- AI-assisted literature mining reveals hidden connections between fields.
- Data fusion across physics, chemistry, biology, and engineering domains.
- Predictive modeling suggests novel research directions.
    `,
   imageUrl:
      "https://images.unsplash.com/photo-1693919653649-27492e78899d?q=80&w=3132&auto=format&fit=crop&ixlib=rb-4.1.0",
  },
  {
    name: "Seamless Collaboration and Knowledge Sharing",
    description: `
Move from isolated data silos to unified research ecosystems.
- API-ready integration with institutional databases and lab systems.
- Secure, role-based data sharing with collaborators worldwide.
- Export data and reports in compliance with funding and journal requirements.
    `,
   imageUrl:
      "https://images.unsplash.com/photo-1693919653649-27492e78899d?q=80&w=3132&auto=format&fit=crop&ixlib=rb-4.1.0",
  },
...
export default function ArExploreModulesSection() {
