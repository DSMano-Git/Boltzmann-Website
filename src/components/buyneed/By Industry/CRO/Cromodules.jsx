...
const modules = [
  {
    name: "Shorten Project Timelines",
    description: `
Traditional CRO timelines can delay client deliverables—our platform helps you compress them significantly.
- AI-powered site and investigator matching accelerates study activation.
- Predictive recruitment models reduce screening failures.
- Automated quality checks catch data discrepancies in real-time.
    `,
    imageUrl:
      "https://images.unsplash.com/photo-1693919653649-27492e78899d?q=80&w=3132&auto=format&fit=crop&ixlib=rb-4.1.0",
  },
  {
    name: "Reduce Operational Risk and Cost",
    description: `
Maximize your margins and client satisfaction by eliminating inefficiencies.
- Forecast and prevent protocol deviations before they impact timelines.
- AI-based adverse event detection ensures early intervention.
- Intelligent resource allocation reduces unnecessary spend.
    `,
    imageUrl:
      "https://images.unsplash.com/photo-1693919653649-27492e78899d?q=80&w=3132&auto=format&fit=crop&ixlib=rb-4.1.0",
  },
  {
    name: "Unlock Competitive Advantage",
    description: `
Stay ahead in the CRO marketplace with AI-enhanced capabilities.
- Leverage predictive analytics for higher bid-winning accuracy.
- Offer faster, more transparent project updates to sponsors.
- Run adaptive trials with real-time decision-making support.
    `,
    imageUrl:
      "https://images.unsplash.com/photo-1693919653649-27492e78899d?q=80&w=3132&auto=format&fit=crop&ixlib=rb-4.1.0",
  },
  {
    name: "Seamless Collaboration with Sponsors",
    description: `
Deliver value from contract signing to final report without friction.
- API-ready integrations with EDC, CTMS, and LIMS systems.
- Collaborative dashboards align CRO teams, investigators, and clients.
- Compliance-ready data exports for global regulatory bodies.
    `,
    imageUrl:
      "https://images.unsplash.com/photo-1693919653649-27492e78899d?q=80&w=3132&auto=format&fit=crop&ixlib=rb-4.1.0",
  },
