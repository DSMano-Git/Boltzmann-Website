...
// export default function PharmacoloZigZagSection() {
//   const features = [
//     {
//       title: "Accelerate Ideation",
//       desc: "Generate novel, target-specific compounds with desired properties faster than ever.",
...
const features = [
  {
    ...
    desc: "Model drug–target interactions and downstream biological effects in silico.",
    color: "#0f766e", // teal
    icon: <Activity size={64} color="white" />,
  },
  {
    title: "Efficacy & Safety Prediction",
    desc: "Predict efficacy and safety profiles before costly experiments.",
    color: "#065f46", // dark green
    icon: <ShieldCheck size={64} color="white" />,
  },
  {
    title: "Candidate Prioritization",
    desc: "Prioritize candidates based on therapeutic potential and side-effect risk.",
    color: "#134e4a", // deep teal
    icon: <Star size={64} color="white" />,
  },
];
