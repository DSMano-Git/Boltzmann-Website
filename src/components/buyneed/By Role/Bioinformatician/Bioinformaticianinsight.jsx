...
// import React from "react";
// import { Database, BookOpen, Microscope } from "lucide-react";
// import { motion } from "framer-motion";

// export default function BioinsightZigZagSection() {
//   const features = [
//   {
//     title: "Unified Multi-Omics Integration",
//     desc: "Integrate multi-omics data into a unified, searchable knowledge base for discovery.",
//     color: "#0ea5e9", // blue
//     icon: <Database size={64} color="white" />,
//   },
//   {
//     title: "Automated Literature Mining",
//     desc: "Automate literature mining to surface hidden target–disease connections.",
//     color: "#f59e0b", // amber
//     icon: <BookOpen size={64} color="white" />,
//   },
//   {
//     title: "Predictive Biomarker Modeling",
//     desc: "Enable predictive modeling for biomarker identification and target validation.",
//     color: "#10b981", // green
//     icon: <Microscope size={64} color="white" />,
//   },
// ];
...
import { Database, BookOpen, LineChart } from "lucide-react";
import { motion } from "framer-motion";
...
const features = [
  ...
  },
  {
    title: "Automated Literature Mining",
    desc: "Automate literature mining to surface hidden target–disease connections.",
    color: "#EA580C", // deeper orange
    icon: <BookOpen size={64} color="white" />,
  },
  {
    title: "Predictive Biomarker Modeling",
    desc: "Enable predictive modeling for biomarker identification and target validation.",
    color: "#ff8400ff", // lighter orange
    icon: <LineChart size={64} color="white" />,
  },
];
