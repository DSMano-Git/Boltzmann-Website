...
export default function CRZigZagSection() {
...
const features = [
  {
    ...
    desc: "Stratify patient cohorts for targeted and efficient clinical trials.",
    color: "#0ea5e9", // bright blue
    icon: <Users size={64} color="white" />,
  },
  {
    title: "Trial Outcome Prediction",
    desc: "Predict trial outcomes to refine design and improve success rates.",
    color: "#0284c7", // darker blue
    icon: <BarChart2 size={64} color="white" />,
  },
  {
    title: "Biomarker Integration",
    desc: "Link preclinical biomarkers with patient data for precision medicine strategies.",
    color: "#0369a1", // deep navy blue
    icon: <HeartPulse size={64} color="white" />,
  },
];
