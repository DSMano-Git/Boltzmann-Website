...
// import React from "react";
// import { Beaker, TrendingUp, FileSpreadsheet } from "lucide-react";
// import { motion } from "framer-motion";

// export default function SynthetichemistZigZagSection() {
//   const features = [
//   {
//     title: "Green Retrosynthesis",
//     desc: "Generate retrosynthetic routes optimized for cost and scalability.",
//     color: "#16a34a", // green
//     icon: <Beaker size={64} color="white" />,
//   },
//   {
//     title: "Feasibility Prediction",
//     desc: "Predict route feasibility using real-world reaction datasets and success probabilities.",
//     color: "#22c55e", // lighter green
//     icon: <TrendingUp size={64} color="white" />,
//   },
//   {
//     title: "Seamless Execution",
//     desc: "Export lab-ready protocols directly into ELNs for seamless execution.",
//     color: "#4ade80", // bright green
//     icon: <FileSpreadsheet size={64} color="white" />,
//   },
// ];
...
import { Atom, Zap, ClipboardCheck } from "lucide-react";
import { motion } from "framer-motion";
...
const features = [
  {
    title: "Retrosynthetic Route Generation",
    desc: "Generate green retrosynthetic routes optimized for cost and scalability.",
    color: "#16a34a", // green
    icon: <Atom size={64} color="white" />,
  },
  {
    title: "Route Feasibility Prediction",
    desc: "Predict route feasibility using real-world reaction datasets and success probabilities.",
    color: "#15803d", // darker green
    icon: <Zap size={64} color="white" />,
  },
  {
    title: "Lab-Ready Protocols",
    desc: "Export lab-ready protocols directly into ELNs for seamless execution.",
    color: "#166534", // deep green
    icon: <ClipboardCheck size={64} color="white" />,
  },
];
