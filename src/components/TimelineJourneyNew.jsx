...
//               setTimeout(() => {
//                 setAnimationPhase(1); // Phase 1: Small to big circle
//                 setTimeout(() => {
//                   setAnimationPhase(2); // Phase 2: All circles appear
//                   setTimeout(() => {
//                     setAnimationPhase(3); // Phase 3: Circles shrink to normal
//                     setTimeout(() => {
//                       setAnimationPhase(4); // Phase 4: Numbers and content animate
//                       setIsLoaded(true);
//                     }, 800);
//                   }, 600);
//                 }, 800);
...
//   // New circle animation variants for the sequential animation
...
//     },
//     bigCircle: {
//       scale: index === 0 ? 2 : 0.3, // Only first circle becomes big
//       opacity: 1,
//       transition: {
//         duration: 0.6,
//         ease: "easeInOut"
...
//     },
//     allCirclesAppear: {
//       scale: index === 0 ? 2 : 2, // All circles become big
//       opacity: 1,
//       transition: {
//         duration: 0.4,
//         delay: index * 0.1,
...
//     if (animationPhase === 0) return "hidden";
//     if (animationPhase === 1) return index === 0 ? "bigCircle" : "smallCircle";
//     if (animationPhase === 2) return "allCirclesAppear";
//     if (animationPhase >= 3) return "normalSize";
//     return "hidden";
//   };
...
//                 strokeWidth="4"
//                 strokeLinecap="round"
//                 animate={animationPhase >= 4 ? { pathLength: 1 } : { pathLength: 0 }}
//                 transition={{ duration: 1.5, ease: "easeInOut" }}
//               />

//               {animationPhase >= 4 && years.map((year, index) => {
//                 const xPos = calculateXPosition(index, years.length);
//                 const yPos = calculateYPosition(index, years.length);
//                 const offset = calculateCardOffset(index);
//                 return (
...
//                       strokeWidth="8"
//                       strokeLinecap="round"
//                       animate={animationPhase >= 4 ? { pathLength: 1, ...getCircleVariants(index)[getCircleState(index)] } : { pathLength: 0, ...getCircleVariants(index)[getCircleState(index)] }}
//                       transition={{ 
//                         pathLength: { duration: 1.5, ease: "easeInOut", delay: index * 0.1 },
//                         ...getCircleVariants(index)[getCircleState(index)]?.transition
//                       }}
//                     />
