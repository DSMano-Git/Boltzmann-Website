...
const MacBookComponent = ({ isOpen = false }) => {
  ...
  const styles = {
    container: {
      ...
      justifyContent: 'center',
      margin: '0 auto',
      padding: deviceSize === 'mobile' ? '10px' : '20px',
    },
    laptop: {
      transformStyle: 'preserve-3d',
      position: 'relative',
      transform: `rotateX(-20deg) rotateY(-30deg) rotateZ(10deg) scale(${scale})`,
    ...
    lid: {
      ...
      right: 1 * scale,
      zIndex: 2,
      boxShadow: `0 ${8 * scale}px ${32 * scale}px rgba(0,0,0,0.25), inset 0 ${1 * scale}px 0 rgba(255,255,255,0.3)`,
      overflow: 'hidden',
      border: `${1 * scale}px solid #d0d0d0`,
      borderBottom: `${2 * scale}px solid #c0c0c0`,
      transition: 'transform 1s ease-out',
      animation: 'lidSequence 2s ease-in-out forwards',
    },
    lidBack: {
    ...
    screenBezel: {
      ...
      width: '100%',
      height: '100%',
      border: `${8 * scale}px solid #0d0d0d`,
    ...
    browserHeader: {
      ...
      borderBottom: `${1 * scale}px solid #e1e1e3`,
    },
    browserControls: {
      display: 'flex',
      gap: `${6 * scale}px`,
    ...
    searchBar: {
      ...
      border: `${1 * scale}px solid #d6d6d8`,
      display: 'flex',
      alignItems: 'center',
    ...
    dataGrid: {
      flex: 1,
      background: '#fff',
      border: `${1 * scale}px solid #e1e1e3`,
      borderRadius: `${4 * scale}px`,
      overflow: 'hidden',
      fontSize: `${8 * scale}px`,
    },
    ...
    gridRow: {
      ...
      gridTemplateColumns: '1fr 1fr 1fr 1fr',
      padding: `${6 * scale}px ${8 * scale}px`,
      borderBottom: `${1 * scale}px solid #f0f0f0`,
      color: '#333',
    },
    base: {
      width: `${352 * scale}px`,
      background: 'linear-gradient(145deg, #e8e8e8, #d0d0d0)',
      padding: `${12 * scale}px`,
      borderRadius: `${4 * scale}px ${4 * scale}px ${18 * scale}px ${18 * scale}px`,
      boxShadow: `0 ${16 * scale}px ${32 * scale}px rgba(0,0,0,0.3), inset 0 ${1 * scale}px 0 rgba(255,255,255,0.3)`,
      transform: `translateY(${-2 * scale}px)`,
      zIndex: 1,
      position: 'relative',
      border: `${1 * scale}px solid #c0c0c0`,
      borderTop: `${2 * scale}px solid #b8b8b8`,
    },
    keyboard: {
      background: 'linear-gradient(145deg, #f0f0f0, #e0e0e0)',
      padding: `${12 * scale}px`,
      ...
      boxShadow: `inset 0 ${2 * scale}px ${4 * scale}px rgba(0,0,0,0.1)`,
      border: `${1 * scale}px solid #d0d0d0`,
    },
    key: {
      background: 'linear-gradient(145deg, #2a2a2a, #1a1a1a)',
      ...
      boxShadow: `inset 0 ${-1 * scale}px ${2 * scale}px rgba(255,255,255,0.1), 0 ${1 * scale}px ${2 * scale}px rgba(0,0,0,0.3)`,
