...
import React, { useEffect, useRef, useState } from "react";
import {
  FlaskConical,  // for "Design Novel Synthetic Pathways with Confidence"
  Beaker,        // for "Streamline Planning to Lab Execution"
  Atom,          // for "Built for Innovation, Backed by Science"
  Rocket,        // for "Your Competitive Edge in Synthetic Chemistry"
} from "lucide-react";
...
export default function SyntheticInsightCards() {
  const cards = [
  {
    ...
    iconType: "flask-conical", // chemistry / synthesis
  },
  {
    title: "Streamline Planning to Lab Execution",
    description:
  ...
  },
  {
    ...
    accent: "rgba(236,72,153,1)",
    shadow: "rgba(236,72,153,0.25)",
    iconType: "atom", // scientific reasoning
  },
  {
    title: "Your Competitive Edge in Synthetic Chemistry",
    description:
    ...
    accent: "rgba(250,204,21,1)",
    shadow: "rgba(250,204,21,0.25)",
    iconType: "rocket", // speed & competitive edge
  },
];
