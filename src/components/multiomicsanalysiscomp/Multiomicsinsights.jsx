...
// export default function SyntheticInsightCards() {
// const cards = [
//   {
//     title: "Design Novel Synthetic Pathways with Confidence",
//     description:
//       "Go beyond standard route planning. Our AI leverages vast reaction databases, literature mining, and predictive modeling to generate novel synthetic routes that balance feasibility, yield, and cost. Every suggestion is scored for scalability, sustainability, and regulatory compliance—helping you make informed decisions in record time.",
//     gradient:
//       "linear-gradient(135deg, rgba(79,70,229,0.15), rgba(129,140,248,0.1))", // deep blue gradient
//     accent: "rgba(79,70,229,1)", // bold blue
//     shadow: "rgba(79,70,229,0.25)",
//     iconType: "flask", // chemistry/reaction icon
//   },
//   {
//     title: "Streamline Planning to Lab Execution",
//     description:
//       "From retrosynthesis to reagent selection, our platform integrates prediction engines, automated worklists, and lab connectivity in one seamless environment. Collaborate across teams, reduce trial-and-error cycles, and accelerate time from design to bench.",
//     gradient:
//       "linear-gradient(135deg, rgba(16,185,129,0.15), rgba(110,231,183,0.1))", // green gradient
//     accent: "rgba(16,185,129,1)", // vibrant green
//     shadow: "rgba(16,185,129,0.25)",
//     iconType: "cpu", // process/automation icon
//   },
//   {
//     title: "Built for Innovation, Backed by Science",
//     description:
//       "Our models explain their predictions with transparent reaction mapping, mechanism visualizations, and links to literature precedent. You get not just a proposed route, but the 'why' behind it—grounding every decision in validated chemistry.",
//     gradient:
//       "linear-gradient(135deg, rgba(236,72,153,0.15), rgba(251,207,232,0.1))", // pink/purple gradient
//     accent: "rgba(236,72,153,1)",
//     shadow: "rgba(236,72,153,0.25)",
//     iconType: "book-open", // knowledge/science icon
//   },
//   {
//     title: "Your Competitive Edge in Synthetic Chemistry",
//     description:
//       "In industries where cost, time, and yield define success, our AI Chemistry Suite equips you to design smarter, minimize waste, and stay ahead of the competition.",
//     gradient:
//       "linear-gradient(135deg, rgba(250,204,21,0.15), rgba(253,230,138,0.1))", // yellow gradient
//     accent: "rgba(250,204,21,1)",
//     shadow: "rgba(250,204,21,0.25)",
//     iconType: "trending-up", // growth/performance icon
//   },
// ];
...
import React, { useEffect, useRef, useState } from "react";
import { Workflow, BarChart3, Database, BrainCircuit } from "lucide-react";

export default function MultiomicsInsightCards() {


const cards = [
  {
    title: "Decode Biology at Unprecedented Scale",
    description:
      "Go beyond siloed datasets. Our AI-powered analysis suite integrates and harmonizes multi-omics data—revealing cross-layer interactions, regulatory networks, and hidden biological patterns. Each result is accompanied by relevance scoring, pathway mapping, and predictive insights to accelerate hypothesis generation.",
    gradient:
      "linear-gradient(135deg, rgba(99,102,241,0.15), rgba(165,180,252,0.1))",
    accent: "rgba(99,102,241,1)",
    shadow: "rgba(99,102,241,0.25)",
    iconType: "workflow", // replaced dna
  },
  {
    title: "Streamline Analysis to Interpretation",
    description:
      "From QC and normalization to advanced statistical modeling, our platform automates labor-intensive tasks while giving you full transparency into every step. Collaborate across teams, compare cohorts, and overlay clinical data—all in one workspace.",
    gradient:
      "linear-gradient(135deg, rgba(34,197,94,0.15), rgba(110,231,183,0.1))",
    accent: "rgba(34,197,94,1)",
    shadow: "rgba(34,197,94,0.25)",
    iconType: "barchart", // replaced cog
  },
  {
    title: "Built for Precision, Backed by Science",
    description:
      "We combine state-of-the-art algorithms with curated biological knowledge to ensure your analyses are both cutting-edge and biologically meaningful. The result? More confident discoveries and fewer blind alleys.",
    gradient:
      "linear-gradient(135deg, rgba(236,72,153,0.15), rgba(251,207,232,0.1))",
    accent: "rgba(236,72,153,1)",
    shadow: "rgba(236,72,153,0.25)",
    iconType: "database", // replaced microscope
  },
  {
    title: "Your Competitive Edge in Omics-Driven Research",
    description:
      "In the race to decode complex biology, our AI Multi-Omics Suite equips you to explore deeper, discover faster, and innovate ahead of the curve.",
    gradient:
      "linear-gradient(135deg, rgba(250,204,21,0.15), rgba(253,230,138,0.1))",
    accent: "rgba(250,204,21,1)",
    shadow: "rgba(250,204,21,0.25)",
    iconType: "brain", // replaced rocket
  },
];
