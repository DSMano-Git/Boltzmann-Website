...
const modules = [
  {
    name: "Agents in Multi-Omics Analysis",
    description:
      "Impact Statement: Your autonomous biological insight engine. Our specialized agents for data preprocessing, statistical modeling, pattern recognition, and biological interpretation work in concert—transforming raw omics data into meaningful hypotheses 24/7.",
    imageUrl:
  ...
  },
  {
    ...
    description:
      "Impact Statement: See the whole biological picture—instantly. Our AI agents merge genomics, transcriptomics, proteomics, metabolomics, and more into a unified analytical framework—removing data silos and revealing system-level insights.",
    imageUrl:
      "https://images.unsplash.com/photo-1693919653649-27492e78899d?q=80&w=3132&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  },
  {
    ...
    description:
      "Impact Statement: Find the most predictive biomarkers in record time. From feature selection to multi-cohort validation, our platform pinpoints high-value biomarkers with predictive and prognostic power—backed by statistical rigor.",
    imageUrl:
    "https://images.unsplash.com/photo-1693919653649-27492e78899d?q=80&w=3132&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  },
  {
    ...
    description:
      "Impact Statement: Understand the mechanisms behind the signals. Our AI maps multi-omics data onto known and predicted biological pathways, uncovering regulatory relationships and identifying novel intervention points.",
    imageUrl:
     "https://images.unsplash.com/photo-1693919653649-27492e78899d?q=80&w=3132&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  },
...
export default function MultiomicsModulesSection() {
  const [selected, setSelected] = useState(0);
  const [isMobile, setIsMobile] = useState(window.innerWidth <= 768);
  const tabRefs = useRef([]);
  const [indicatorStyle, setIndicatorStyle] = useState({ width: 0, left: 0 });
