          ...
          <div style={{
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "30px", marginTop: "40px" }}>
              <div
                style={{
                  ...
                  opacity: 0.8,
                  transform: "rotate(-5deg)",
                  backgroundImage: "url('./1mission.png')", // Change this path
              ...
              <div
                style={{
                  ...
                  opacity: 0.8,
                  transform: "rotate(3deg)",
                  backgroundImage: "url('./twomission.png')", // Change this path
            ...
            <div
              style={{
                ...
                opacity: 0.8,
                transform: "rotate(2deg)",
                backgroundImage: "url('./3mission.png')", // Change this path
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div
                style={{
                  ...
                  opacity: 0.8,
                  transform: "rotate(-5deg)",
                  backgroundImage: "url('./innovation-icon.png')", // Change this path
              ...
              <div
                style={{
                  ...
                  opacity: 0.8,
                  transform: "rotate(2deg)",
                  backgroundImage: "url('./technology-icon.png')", // Change this path
                  backgroundSize: "60px 60px",
                  backgroundRepeat: "no-repeat",
                  backgroundPosition: "center"
                }}
            ...
            <div
              style={{
                ...
                opacity: 0.8,
                transform: "rotate(3deg)",
                backgroundImage: "url('./research-icon.png')", // Change this path
                backgroundSize: "50px 50px",
                backgroundRepeat: "no-repeat",
                backgroundPosition: "center"
              }}
