...
//     items: [
//       { label: 'Medicinal Chemists', path: '/medicinal-chemists', parentMenu: 'By Need' },
//       { label: 'Bioinformatics', path: '/bioinformatics',  parentMenu: 'By Need' },
//       { label: 'Synthetic Chemists', path: '/synthetic-chemists', parentMenu: 'By Need' },
//       { label: 'Pharmacologists', path: '/pharmacologist', parentMenu: 'By Need' },
//       { label: 'Clinical Researchers', path: '/clinical-researchers', parentMenu: 'By Need' },
//     ]
//   },
//   {
//     title: 'By Industry',
...
//     items: [
//       { label: 'Pharmaceuticals & Biotechnology', path: '/pharmaceuticals-biotech', parentMenu: 'By Need' },
//       { label: 'Chemicals', path: '/chemicals', parentMenu: 'By Need' },
//       { label: 'Agrochemicals and Crop Science', path: '/agrochemicals',  parentMenu: 'By Need' },
//       { label: 'CROs', path: '/cros',  parentMenu: 'By Need' },
//       { label: 'Academic Research', path: '/academic-research',  parentMenu: 'By Need' },
//       { label: 'Precision Medicine', path: '/precision-medicine',  parentMenu: 'By Need' },
//       { label: 'Material Science', path: '/material-science', parentMenu: 'By Need' },
//       { label: 'Clinical Trials & Healthcare', path: '/clinical-trials',  parentMenu: 'By Need' },
//     ]
//   }
// ];
...
export default function NavbarPage() {
      ...
      >
        <Toolbar sx={{ 
          ...
          <Box sx={{ 
                          ...
                          {product.isVideo ? (
                            <Box
                              ...
                              onError={(e) => {
                                ...
                                img.src = 'https://via.placeholder.com/280x120?text=Product+Video';
                                img.style.width = '100%';
                                img.style.height = `${gridConfig.imgHeight}px`;
            ...
            {/* Desktop Action Buttons - Only show if NOT on contact page */}
            {!isMobile && !isContactPage && (
  ...
  rel="noopener noreferrer"
      ...
      >
        <Box sx={{ width: '100%', height: '100%' }}>
          <Box display="flex" justifyContent="space-between" alignItems="center" p={2}>
            <Typography variant="h6" sx={{ color: '#4F1985', fontWeight: 600,fontFamily: 'times' }}>
              Menu
            </Typography>
            <IconButton 
              onClick={() => setDrawerOpen(false)}
          ...
          <Divider />
          {/* Mobile Action Buttons - Only show if NOT on contact page */}
          {!isContactPage && (
