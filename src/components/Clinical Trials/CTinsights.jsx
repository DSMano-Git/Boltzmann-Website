...
export default function CTInsightCards() {
 const cards = [
  {
    title: "Design Adaptive, Patient-Centric Trials",
    description:
      "Move beyond static protocols. Our platform uses advanced AI to design adaptive trial strategies incorporating biomarker-driven cohorts and real-time data monitoring. Achieve higher patient retention, faster recruitment, and more meaningful endpoints.",
    gradient:
      "linear-gradient(135deg, rgba(99,102,241,0.15), rgba(165,180,252,0.1))",
    accent: "rgba(99,102,241,1)",
    shadow: "rgba(99,102,241,0.25)",
    iconType: "users", // patient-centric, adaptive cohorts
  },
  {
    title: "Predict Outcomes with Confidence",
    description:
      "Leverage multi-modal clinical, genomic, and real-world data to forecast efficacy, safety signals, and trial risks before they arise. Make informed go/no-go decisions earlier to reduce costly late-stage failures.",
    gradient:
      "linear-gradient(135deg, rgba(34,197,94,0.15), rgba(110,231,183,0.1))",
    accent: "rgba(34,197,94,1)",
    shadow: "rgba(34,197,94,0.25)",
    iconType: "activity", // outcomes, risk prediction
  },
  {
    title: "Automate Workflows, Accelerate Insights",
    description:
      "From site selection and monitoring to data cleaning and reporting, our multi-agent system automates routine tasks to reduce human error, cut timelines, and ensure compliance. Collaborate seamlessly across sponsors, CROs, and investigators within one unified workspace.",
    gradient:
      "linear-gradient(135deg, rgba(236,72,153,0.15), rgba(251,207,232,0.1))",
    accent: "rgba(236,72,153,1)",
    shadow: "rgba(236,72,153,0.25)",
    iconType: "workflow", // automation & workflows
  },
  {
    title: "Built for Compliance, Powered by Transparency",
    description:
      "Regulatory-grade data provenance, audit trails, and explainable AI models ensure full transparency and trust. Your clinical development stays on track while meeting evolving global standards.",
    gradient:
      "linear-gradient(135deg, rgba(250,204,21,0.15), rgba(253,230,138,0.1))",
    accent: "rgba(250,204,21,1)",
    shadow: "rgba(250,204,21,0.25)",
    iconType: "shield-check", // compliance & trust
  },
];
