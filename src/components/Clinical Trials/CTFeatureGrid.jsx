...
const features = [
  ...
  },
  {
    ...
    bgColor: "#38bdf8", // Light Blue
    hoverColor: "#0ea5e9",
  },
  {
    icon: AlertCircle,
    title: "Real-Time Adverse Event Monitoring",
  ...
  {
    icon: Database,
    title: "Integrate Clinical & Omics Data",
  ...
  {
    icon: ShieldCheck,
    title: "Secure Collaborative Dashboards",
