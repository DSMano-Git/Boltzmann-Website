...
const modules = [
  {
    name: "Trial Design & Simulation",
    description:
      "Impact Statement: Model and optimize trial protocols before initiation. AI-powered simulation agents test multiple scenarios to predict enrollment, statistical power, and endpoint performance—helping you design trials that succeed the first time.",
    imageUrl:
      "https://images.unsplash.com/photo-1693919653649-27492e78899d?auto=format&fit=crop&w=800&q=80",
  },
  {
    name: "Patient Recruitment & Stratification",
    description:
      "Impact Statement: Find and engage the right patients faster. Utilize AI to analyze EMRs, genomic databases, and wearable data to identify ideal trial candidates. Personalized recruitment strategies improve enrollment speed and diversity.",
    imageUrl:
      "https://images.unsplash.com/photo-1693919653649-27492e78899d?auto=format&fit=crop&w=800&q=80",
  },
  {
    name: "Real-Time Monitoring & Risk Management",
    description:
      "Impact Statement: Proactively manage trial safety and data quality. Continuous AI-driven monitoring detects anomalies, adverse events, and protocol deviations early—enabling rapid corrective actions and safeguarding patient wellbeing.",
    imageUrl:
      "https://images.unsplash.com/photo-1693919653649-27492e78899d?auto=format&fit=crop&w=800&q=80",
  },
  {
    name: "Regulatory Submission & Reporting",
    description:
      "Impact Statement: Accelerate approval with confidence. Automate data aggregation, cleaning, and generation of submission-ready reports compliant with regulatory guidelines, reducing manual workload and expediting review timelines.",
    imageUrl:
      "https://images.unsplash.com/photo-1693919653649-27492e78899d?auto=format&fit=crop&w=800&q=80",
  },
];
...
export default function CTModulesSection() {
  const [selected, setSelected] = useState(0);
  const [isMobile, setIsMobile] = useState(window.innerWidth <= 768);
  const tabRefs = useRef([]);
  const [indicatorStyle, setIndicatorStyle] = useState({ width: 0, left: 0 });
