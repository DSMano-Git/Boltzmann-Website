...
//     const newProgress = lerp(currentProgress, targetProgress, easingFactor);
...
//       const active = progress >= idx / totalSegments;
...
//         if (delta > 0) {
//           // Scrolling down
//           timelineProgressRef.current = Math.min(1, timelineProgressRef.current + scrollSpeed);
//         } else {
//           // Scrolling up
//           if (timelineProgressRef.current <= 0.02) {
//             // Exit to previous section
//             exitTimelineBackward();
//             return;
//           }
//           timelineProgressRef.current = Math.max(0, timelineProgressRef.current - scrollSpeed);
//         }
        
//         // Check for completion
//         if (timelineProgressRef.current >= 0.98 && !isTimelineComplete) {
...
//         if (timelineProgressRef.current < 0.9 && isTimelineComplete) {
//           setIsTimelineComplete(false);
//           setShowCompletionSection(false);
//           setCanExitTimeline(false);
//         }
...
//           setIsTimelineComplete(false);
//           setCanExitTimeline(false);
//           timelineProgressRef.current = 0.85;
