...
// const features = [
//   { icon: Bot, title: "AI-Powered Hit Identification", description: "Rapidly scan millions of compounds to find promising hits in days, not months.", bgColor: "#6366f1", hoverColor: "#4f46e5" },
//   { icon: Shield, title: "Predictive ADMET Screening", description: "Spot toxicity and pharmacokinetic risks before entering the lab.", bgColor: "#f43f5e", hoverColor: "#e11d48" },
//   { icon: Atom, title: "Generative Molecule Design", description: "Create novel compounds beyond known chemical space with AI creativity.", bgColor: "#38bdf8", hoverColor: "#0ea5e9" },
//   { icon: TrendingUp, title: "SAR & Potency Prediction", description: "Optimize structure–activity relationships with data-driven precision.", bgColor: "#f97316", hoverColor: "#ea580c" },
//   { icon: GitBranch, title: "Retrosynthesis Planning", description: "Identify the fastest, most cost-effective, and green synthesis routes.", bgColor: "#f59e0b", hoverColor: "#d97706" },
//   { icon: Dna, title: "Multi-Omics Integration", description: "Uncover unique biomarkers and targets with cross-domain datasets.", bgColor: "#9333ea", hoverColor: "#7c3aed" },
//   { icon: Microscope, title: "Virtual Screening at Scale", description: "Run high-throughput in silico assays with unprecedented speed.", bgColor: "#10b981", hoverColor: "#059669" },
//   { icon: Users, title: "Collaborative Research Workspaces", description: "Share, review, and iterate on designs in secure, real-time environments.", bgColor: "#ea580c", hoverColor: "#c2410c" },
// ];
...
//     // make card stretch to fill grid cell
//     height: "100%",
...
//     lineHeight: "1.6",
//     transition: "color 0.3s ease",
//     flexGrow: 1, // ensure description grows to fill remaining height
//   };
...
// export default function SmallFeaturesGrid() {
...
import React from "react";
import { Search, ShieldCheck, FlaskConical, Activity, Route, Layers, Scan, Users } from "lucide-react";
...
const features = [
  {
    icon: Search,
    title: "AI-Powered Hit Identification",
    description: "Rapidly scan millions of compounds to find promising hits in days, not months.",
    bgColor: "#6366f1",
    hoverColor: "#4f46e5"
  },
  {
    icon: ShieldCheck,
    title: "Predictive ADMET Screening",
    description: "Spot toxicity and pharmacokinetic risks before entering the lab.",
    bgColor: "#f43f5e",
    hoverColor: "#e11d48"
  },
  {
    icon: FlaskConical,
    title: "Generative Molecule Design",
    description: "Create novel compounds beyond known chemical space with AI creativity.",
    bgColor: "#38bdf8",
    hoverColor: "#0ea5e9"
  },
  {
    icon: Activity,
    title: "SAR & Potency Prediction",
    description: "Optimize structure–activity relationships with data-driven precision.",
    bgColor: "#f97316",
    hoverColor: "#ea580c"
  },
  {
    icon: Route,
    title: "Retrosynthesis Planning",
    description: "Identify the fastest, most cost-effective, and green synthesis routes.",
    bgColor: "#f59e0b",
    hoverColor: "#d97706"
  },
  {
    icon: Layers,
    title: "Multi-Omics Integration",
    description: "Uncover unique biomarkers and targets with cross-domain datasets.",
    bgColor: "#9333ea",
    hoverColor: "#7c3aed"
  },
  {
    icon: Scan,
    title: "Virtual Screening at Scale",
    description: "Run high-throughput in silico assays with unprecedented speed.",
    bgColor: "#10b981",
    hoverColor: "#059669"
  },
  {
    icon: Users,
    title: "Collaborative Research Workspaces",
    description: "Share, review, and iterate on designs in secure, real-time environments.",
    bgColor: "#ea580c",
    hoverColor: "#c2410c"
  },
];
