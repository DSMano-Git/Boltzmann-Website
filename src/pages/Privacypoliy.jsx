  ...
  return (
    <div className="terms-container">
      <div className="terms-header">
        ...
        <p className="last-updated">Last Update: June 2025</p>
      </div>
      ...
      <div className="terms-content">
        ...
        <div className="terms-main">
          <section id="intro" className="terms-section">
            <p>
              BOLTZMANN Labs Private Limited (hereafter referred to as BOLTZMANN Labs) ("us", "we", or "our") operates the Boltzmann website (www.boltzmann.co) and a suite of related websites, web applications, and services (collectively, the "Service"), including but not limited to: Boltzmann AI Discovery Suite (www.app.boltzmann.co), BoltChem (www.boltchem.com and boltchem.boltzmann.co), BoltPro (boltpro.boltzmann.co), ReBolt (rebolt.boltzmann.co), and BoltBio (boltbio.boltzmann.co).
            </p>
            <p>
          ...
          <section id="definitions" className="terms-section">
            ...
            Services are the websites that operate under BOLTZMANN Labs.</p>
            
            <p><strong>Personal Data</strong><br />
            Personal Data means data about a living individual who can be identified from that data (or from those and other information either in our possession or likely to come into our possession).</p>
            ...
            Cookies are small pieces of data stored on your device (computer or mobile device).</p>
            
            <p><strong>Data Controller</strong><br />
            Data Controller means the natural or legal person who (either alone or jointly or in common with other persons) determines the purposes for which and the manner in which any personal information is, or are to be, processed.<br />
            For the purpose of this Privacy Policy, we are a Data Controller of your Personal Data.</p>
            
            <p><strong>Data Processors (or Service Providers)</strong><br />
            ...
            <p><strong>Data Subject (or User)</strong><br />
          ...
          <section id="use" className="terms-section">
            <h2>Use of Data</h2>
            <p>BOLTZMANN Labs uses the collected data for various purposes:</p>
            <ul>
          ...
          <section id="gdpr" className="terms-section">
            <h2>Legal Basis for Processing Personal Data Under General Data Protection Regulation (GDPR)</h2>
            <p>If you are from the European Economic Area (EEA), BOLTZMANN Labs legal basis for collecting and using the personal information described in this Privacy Policy depends on the Personal Data we collect and the specific context in which we collect it.</p>
            <p>BOLTZMANN Labs may process your Personal Data because:</p>
            <ul>
          ...
          <section id="retention" className="terms-section">
            ...
            <p>BOLTZMANN Labs will retain your Personal Data only for as long as is necessary for the purposes set out in this Privacy Policy. We will retain and use your Personal Data to the extent necessary to comply with our legal obligations (for example, if we are required to retain your data to comply with applicable laws), resolve disputes, and enforce our legal agreements and policies.</p>
            <p>BOLTZMANN Labs will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for a shorter period of time, except when this data is used to strengthen the security or to improve the functionality of our Service, or we are legally obligated to retain this data for longer time periods.</p>
          </section>

          <section id="transfer" className="terms-section">
            <h2>Transfer of Data</h2>
            <p>Your information, including Personal Data, may be transferred to – and maintained on – computers located outside of your state, province, country or other governmental jurisdiction where the data protection laws may differ than those from your jurisdiction.</p>
            <p>If you are located outside the United States and choose to provide information to us, please note that we transfer the data, including Personal Data, to India and process it there.</p>
            <p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement to that transfer.</p>
            <p>BOLTZMANN Labs will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
          </section>

          <section id="disclosure" className="terms-section">
            <h2>Disclosure of Data</h2>
            <p><strong>Disclosure for Law Enforcement</strong><br />
            Under certain circumstances, BOLTZMANN Labs may be required to disclose your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
            
            <p><strong>Legal Requirements</strong><br />
            BOLTZMANN Labs may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
            <ul>
              <li>To comply with a legal obligation</li>
              <li>To protect and defend the rights or property of BOLTZMANN Labs</li>
          ...
          <section id="dnt" className="terms-section">
          ...
          <section id="rights" className="terms-section">
            ...
            <p>If you are a resident of the European Economic Area (EEA), you have certain data protection rights. BOLTZMANN Labs aims to take reasonable steps to allow you to correct, amend, delete, or limit the use of your Personal Data.</p>
            ...
            <ul>
              ...
              <li><strong>The right to withdraw consent.</strong> You also have the right to withdraw your consent at any time where BOLTZMANN Labs relied on your consent to process your personal information.</li>
            </ul>
            <p>Please note that we may ask you to verify your identity before responding to such requests.</p>
            <p>You have the right to complain to a Data Protection Authority about our collection and use of your Personal Data. For more information, please contact your local data protection authority in the European Economic Area (EEA).</p>
          </section>

          <section id="providers" className="terms-section">
          ...
          <section id="contact" className="terms-section">
            ...
            <p>By email: contact@boltzamnn.co</p>
            <p>Copyright © 2025 BOLTZMANN Labs Private Limited All rights reserved.</p>
          </section>
        </div>
      </div>
      ...
      <style jsx>{`
        ...
        .terms-sidebar button:hover {
          color: #4F1985;
          background: rgba(79, 25, 133, 0.05);
        }
        
        .terms-sidebar button.active {
          color: #4F1985;
          font-weight: 600;
          background: rgba(79, 25, 133, 0.1);
        }
