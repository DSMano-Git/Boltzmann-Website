...
//             <p style={sectionTitle}>Our Customers</p>
...
//                 <div style={iconBox}><FaEnvelope /></div>
//                 <div>
//                   <h3 style={detailTitle}>Email Us</h3>
//                   <p style={detailText}>contact@boltzmann.co</p>
//                 </div>
//               </div>

//               <div style={contactItem}>
//                 <div style={iconBox}><FaPhoneAlt /></div>
//                 <div>
//                   <h3 style={detailTitle}>Call Us</h3>
//                   <p style={detailText}>+91 9498866488</p>
//                 </div>
//               </div>

//               <div style={contactItem}>
//                 <div style={iconBox}><FaMapMarkerAlt /></div>
//                 <div>
//                   <h3 style={detailTitle}>Visit Us</h3>
//                   <p style={detailText}>
...
//             style={formBox}
//           >
//             <h3 style={formTitle}>We'd Love to Hear from You</h3>
...
//                 whileTap={{ scale: 0.97 }}
//                 style={{ ...button, margin: '20px auto 0 auto', display: 'flex', justifyContent: 'center' }}
//               >
//                 {isSubmitting ? (
//                   <>
//                     <svg
    ...
    <>
      ...
      <h1
        style={{
          ...
          color: '#1e293b',
          fontFamily: "'Poppins', sans-serif",
          '@media (max-width: 1200px)': { fontSize: '2.7rem' },
          '@media (max-width: 992px)': { fontSize: '2.4rem' },
          '@media (max-width: 768px)': { fontSize: '2.1rem', marginBottom: '40px' },
          '@media (max-width: 480px)': { fontSize: '1.8rem', marginBottom: '30px' },
        }}
      >
        Contact Us
      </h1>
