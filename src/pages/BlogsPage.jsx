...
const BlogsPage = () => {
  ...
  return (
    <div style={{ fontFamily: 'times' }}>
      ...
      {/* Header */}
      <header style={{ textAlign: 'center', padding: '60px 20px', backgroundColor: '#f9f9fb' }}>
  <h1
    style={{
        ...
        >
          ...
          >
            ...
            <button
              ...
              onClick={() => window.location.href = "https://www.linkedin.com/newsletters/boltz-buzz-7119930896895406080/"}
            >
